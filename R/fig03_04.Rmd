...
```{r echo=FALSE}
library(knitr)
opts_chunk$set(fig.width=6, fig.height=3, fig.path='figures/fig03_04-', warning=FALSE)
read_chunk('common.R')
read_chunk('fig03_04.R')
```
